...
if(!array_key_exists('pname', $_POST) || $_POST['name'] == '') {// on verifie l'existence du champ et d'un contenu
...
if(!array_key_exists('tel', $_POST) || $_POST['tel'] == '' || !filter_var($_POST['tel'], FILTER_VALIDATE_EMAIL)) {// on verifie existence de la clé
  $errors ['tel'] = "vous n'avez pas renseigné votre numéro de telephone";
  }
if(!array_key_exists('message', $_POST) || $_POST['message'] == '') {
  $errors ['message'] = "vous n'avez pas renseigné votre message";
  }
if(array_key_exists('antispam', $_POST)) {// on place un petit filet anti robots spammers
  $errors ['antispam'] = "Vous accéptez les conditions";
  }
//On check les infos transmises lors de la validation
  ...
  $to = 'info@inwpartners.com'; // Insérer votre adresse email ICI
